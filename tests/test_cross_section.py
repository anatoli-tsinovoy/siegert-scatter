...
class TestCrossSection:
    ...
    def test_scattering_length(self, poschl_teller):
        ...
        result = calc_cross_section_by_sps(
            poschl_teller, N=50, a=10, l_max=0, E_vec=np.array([0.01]), dtau=np.inf
        )
    ...
    def test_s_matrix_unitarity(self, poschl_teller):
        ...
        result = calc_cross_section_by_sps(
            poschl_teller, N=50, a=10, l_max=3, E_vec=E_vec, dtau=np.inf
        )
    ...
    def test_cross_section_positive(self, poschl_teller):
        ...
        E_vec = np.linspace(0.1, 5, 50)
        result = calc_cross_section_by_sps(
            poschl_teller, N=20, a=10, l_max=3, E_vec=E_vec, dtau=np.inf
        )
    ...
    def test_k_n_l_structure(self, poschl_teller):
        ...
        result = calc_cross_section_by_sps(
            poschl_teller, N=20, a=10, l_max=3, E_vec=np.array([1.0]), dtau=np.inf
        )
    ...
    def test_s_matrix_at_low_energy(self, poschl_teller):
        ...
        E_vec = np.array([1e-4])
        result = calc_cross_section_by_sps(
            poschl_teller, N=50, a=10, l_max=0, E_vec=E_vec, dtau=np.inf
        )
    ...
    def test_partial_wave_ordering(self, poschl_teller):
        ...
        E_vec = np.array([0.01])
        result = calc_cross_section_by_sps(
            poschl_teller, N=30, a=10, l_max=4, E_vec=E_vec, dtau=np.inf
        )
...
class TestCrossSectionSuite:
    ...
    def test_two_potential_comparison(self):
        ...
        result_1 = calc_cross_section_by_sps(
            V_1, N=50, a=10, l_max=5, E_vec=E_vec, dtau=np.inf
        )
        result_2 = calc_cross_section_by_sps(
            V_2, N=50, a=10, l_max=5, E_vec=E_vec, dtau=np.inf
        )
    ...
    def test_energy_grid_shape(self):
        ...
        result = calc_cross_section_by_sps(
            V, N=20, a=10, l_max=3, E_vec=E_vec, dtau=np.inf
        )
